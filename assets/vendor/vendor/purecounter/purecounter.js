        ...
        return a = n, (i = [{
            ...
            value: function() {
                ...
                if (this.intersectionListenerSupported()) {
                    ...
                    window.addEventListener && (this.animateLegacy(e), window.addEventListener("scroll", (function(t) {
            ...
            value: function(e, t) {
                ...
                var o = setInterval((function() {
                    ...
                    ((i = s) >= t.end && "inc" == a || i <= t.end && "dec" == a) && (e.innerHTML = r.formatNumber(t.end, t), clearInterval(o))
                }), t.delay)
            }
        }, {
            key: "parseConfig",
